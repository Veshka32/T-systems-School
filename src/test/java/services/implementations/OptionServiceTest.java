...
//        when(optionDAO.getMandatoryRelation(new String[]{A})).thenReturn(Collections.singletonList(relation)); //a requires b
//        e = assertThrows(ServiceException.class, () -> optionService.create(dto));
...
//        dto.getMandatory().add(B);
//
//        when(optionDAO.getMandatoryRelation(new String[]{A, B})).thenReturn(Arrays.asList(relation, relation1)); //a requires b and z
//        e = assertThrows(ServiceException.class, () -> optionService.create(dto));
...
//        when(optionDAO.getMandatoryRelation(new String[]{A, B})).thenReturn(Collections.emptyList()); //a requires b and z
//        when(optionDAO.getIncompatibleRelation(new String[]{A, B})).thenReturn(Collections.singletonList(relation));
//        e = assertThrows(ServiceException.class, () -> optionService.create(dto));
